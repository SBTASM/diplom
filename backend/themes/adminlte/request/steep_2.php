...
<div class="row">
    <div class="panel panel-primary">
        <div class="panel-heading"><div class="text-center">Дистанции</div> </div>
        <div class="panel-body">
            <div class="col-sm-12">
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        <div class="panel-heading"><div class="text-center">День 1-й (Длинная вода)</div></div>
                        <div class="panel-body">
                            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        <div class="panel-heading"><div class="text-center">День 2-й (Короткая вода)</div></div>
                        <div class="panel-body">
                            <div class="row">
                                <?php foreach ($models as $key => $distance): ?>
        ...
        <div class="panel-footer">
            <div class="text-center">
                <?php if($race == 0){ ?>
                    <?= \yii\bootstrap\Html::submitButton("Подати заявку", ['class' => 'btn btn-danger']) ?>
                <?php }else{ ?>
                    <?= \yii\bootstrap\Html::submitButton("Далі", ['class' => 'btn btn-danger']) ?>
                <?php } ?>
            </div>
        </div>
    </div>
